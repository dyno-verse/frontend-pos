<template>
  <div class="h-full">
    <nav class="bg-white static border-gray-200 dark:bg-gray-900 border-b border-gray-200">
      <div class="flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
          <img src="https://flowbite.com/docs/images/logo.svg" class="h-8" alt="Flowbite Logo"/>
          <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">DynoMenu</span>
        </a>
...
const pages = [
  ...
  },
  {
    name: 'In Preparation',
    icon: '',
    url: '/kds/in-preparation'
  },
  {
    name: 'Ready To Serve',
    icon: '',
    url: '/kds/ready-to-serve'
  }
]
