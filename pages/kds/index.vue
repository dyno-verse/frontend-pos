<template>
  <div class="container">
    <div v-if="!isPending" class="grid grid-cols-5 gap-4 auto-rows-fr items-center justify-items-stretch content-start m-4">

      <div v-for="(order, index) in orders" class="bg-red-50 w-full h-full rounded-lg border border-red-500 p-5" @dblclick="doSomething()">
